...
public:
  ...
  NestedLoopJoinPhysicalOperator(shared_ptr<JoinStmt> join_stmt) : join_stmt_(join_stmt) {}
  ...
  void   set_join_stmt(shared_ptr<JoinStmt> join_stmt) { join_stmt_ = join_stmt; }
